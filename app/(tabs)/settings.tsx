        ...
        <View style={styles.headerSection}>
          ...
          <View style={styles.profileCard}>
            <View style={styles.avatarContainer}>
              ...
              <TouchableOpacity style={styles.editIconBtn} onPress={() => router.push('/pages/profile/profileDetails')}>
            ...
            <View style={styles.emailChip}>
              ...
              {isEmailVerified && <MaterialIcons name="verified" size={14} color={THEME_COLOR} style={{marginLeft:4}} />}
            </View>
          </View>
        </View>
            ...
            <View style={styles.detailRow}>
              ...
              <View style={styles.verticalDivider} />
               <View style={styles.detailItem}>
                ...
                <Text style={[styles.detailValue, { color: isEmailVerified ? '#10B981' : '#F59E0B' }]}>
            ...
            <View style={styles.planHeader}>
              ...
              <View style={{flex: 1}}>
                ...
                <Text style={styles.planStatus}>
                   Status: <Text style={{fontWeight: '700', color: hasActivePlan ? '#10B981' : '#6B7280'}}>{hasActivePlan ? 'Active' : 'Inactive'}</Text>
                </Text>
              </View>
              <View style={[styles.kycBadge, { backgroundColor: isKycVerified ? '#DCFCE7' : '#FEF3C7' }]}>
                 <Text style={[styles.kycBadgeText, { color: isKycVerified ? '#166534' : '#92400E' }]}>
        ...
        <View style={styles.sectionContainer}>
          ...
          <View style={styles.menuContainer}>
            {menuItems.map((item, index) => (
              ...
              >
                <View style={[styles.menuIconBox, { backgroundColor: item.isDestructive ? '#FEF2F2' : '#F3F4F6' }]}>
                  {renderIcon(item)}
                </View>
